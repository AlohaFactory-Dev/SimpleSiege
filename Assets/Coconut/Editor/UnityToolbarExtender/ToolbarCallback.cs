        ...
        static void OnUpdate()
        {
            ...
            if (m_currentToolbar == null)
            {
                ...
                if (m_currentToolbar != null)
                {
                    ...
                    RegisterCallback("ToolbarZoneLeftAlign", FlexDirection.RowReverse, OnToolbarGUILeft);
                    RegisterCallback("ToolbarZoneRightAlign", FlexDirection.Row, OnToolbarGUIRight);

                    void RegisterCallback(string root, FlexDirection flexDirection, Action cb)
                    {
