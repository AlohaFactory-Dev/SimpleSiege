...
namespace Alohacorp.Durian.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.4.12/csharp");
        ...
        {
            string report = "C# SDK (Alohacorp.Durian) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.4.12\n";
            report += "    SDK Package Version: 0.4.12\n";
